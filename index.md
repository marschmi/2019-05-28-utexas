...
helper: ["Alex Nishida","Yiyuan (YY) Li", "Rob Heckman", "Jessica Trelogan"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["marschmi@utexas.edu", "alice.macqueen@utexas.edu "]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://pad.carpentries.org/2019-05-28-utexas            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite: 62210286642          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
<p>Please be sure to complete these surveys before and after the workshop with the workshop id of <strong>2019-05-28-utexas</strong>.</p>
